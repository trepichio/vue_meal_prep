  	          ...
  	          >
  	            <v-card class='fill-height d-flex flex-column'>
  	            	<v-responsive style='flex: none'>
  	            		<v-img :src='item.imageUrl' maxHeight='100%' aspectRatio='1'	></v-img>
  	            	</v-responsive>
  	              ...
  	              <v-list dense>
  	                ...
  	                <v-list-item>
  	                  ...
  	                  <v-list-item-content class="align-end">{{ item.healthLabels.join(', ') }}</v-list-item-content>
  	                </v-list-item>
  	                <v-list-item>
  	                  <v-list-item-content>Cautions:</v-list-item-content>
  	                  <v-list-item-content class="align-end">{{ item.cautions.join(', ') }}</v-list-item-content>
  	                </v-list-item>
  	              </v-list>
